...
function wanted(){return !!document.querySelector(".nv-site-wrap")||/^(?:\/en)?\/(dubai|abudhabi|rak|armenia|georgia)\/(residential|commercial)\/?$/.test(location.pathname)}  /* only where prices are listed */
function mount(){
